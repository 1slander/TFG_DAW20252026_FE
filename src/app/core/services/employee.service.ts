...
export class EmployeeService {
  ...
  },
  {
    ...
    hireDate: '2023-03-15',
    hourlyWage: 18,
    role: { id: 2, roleName: 'MANAGER', roleCategory: 'EMPLOYEE' },
    isActive: true,
  ...
  },
  {
    ...
    hireDate: '2023-04-20',
    hourlyWage: 16,
    role: { id: 3, roleName: 'ASSISTANT_MANAGER', roleCategory: 'EMPLOYEE' },
    isActive: true,
  ...
  },
  {
    ...
    hireDate: '2023-05-05',
    hourlyWage: 15,
    role: { id: 4, roleName: 'TEAM_LEADER', roleCategory: 'EMPLOYEE' },
    isActive: true,
  ...
  },
  {
    ...
    hireDate: '2023-06-01',
    hourlyWage: 13,
    role: { id: 5, roleName: 'EMPLOYEE', roleCategory: 'EMPLOYEE' },
    isActive: true,
